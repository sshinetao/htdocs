...
<html lang="zh-CN">
 ...
 <script>
  ...
  <form class="form-horizontal" action="<?php echo U('Admin/Article/doAdd');?>" method="POST">
    <fieldset>
          ...
          <div class="controls">
            <input type="text" placeholder="填写标签名称" class="form-control " name="title">
...
<div class="control-group">
          ...
          <div class="controls">
			...
			<?php if(is_array($CateList)): foreach($CateList as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
				  </select>
          </div>
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" placeholder="排序号" class="form-control " name="porder">
